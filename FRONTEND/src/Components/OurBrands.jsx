  ...
  const brands = [
    {
      ...
      img: 'https://via.placeholder.com/300x200?text=Lemon+Tree+Premier',
    ...
    },
    {
      ...
      img: 'https://via.placeholder.com/300x200?text=Lemon+Tree+Hotels',
    ...
    },
    {
      ...
      img: 'https://via.placeholder.com/300x200?text=Red+Fox+Hotels',
    ...
    },
    {
      ...
      img: 'https://via.placeholder.com/300x200?text=Keys+Hotels',
  ...
  return (
    <div className="bg-gray-50">
      ...
      <div
        ...
        style={{
          backgroundImage: `url('https://via.placeholder.com/1920x1080?text=Our+Brands+Background')`, 
        }}
      >
